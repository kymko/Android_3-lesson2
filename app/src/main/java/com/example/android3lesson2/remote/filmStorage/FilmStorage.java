package com.example.android3lesson2.remote.filmStorage;

import android.util.Log;

import com.example.android3lesson2.data.Films;
import com.example.android3lesson2.remote.RetrofitBuilder;
...
public class FilmStorage {
    ...
    public void getFilm(String filmId, Callbacks<Films> callbacks) {
        RetrofitBuilder.getInstance().getFilms(filmId).enqueue(new Callback<Films>() {
            @Override
